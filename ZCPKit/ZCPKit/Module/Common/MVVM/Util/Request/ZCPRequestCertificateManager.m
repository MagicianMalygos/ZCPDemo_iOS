...
typedef void (^ZCPRequestCertificateSuccessHandler)();
typedef void (^ZCPRequestCertificateFailureHandler)();
...
- (void)allowHttpsCertificate:(NSString *)httpsURL completion:(void(^)())completion {
    [self allowHttpsCertificate:httpsURL success:completion failure:completion];
}
#pragma mark 允许https的证书通过
- (void)allowHttpsCertificate:(NSString *)httpsURL success:(void (^)())success failure:(void (^)())failure {
